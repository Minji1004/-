    ...
    <div class="body-notice" style="width: 800px; margin: 0 auto;">
        ...
        <div>
			...
			<table style="width: 100%; margin: 0px auto; border-spacing: 0px; border-collapse: collapse;">
			  <tr align="center" bgcolor="#29D9C2" height="35" style="border-top: 1px solid #cccccc; border-bottom: 1px solid #cccccc;"> 
			...
			<table style="width: 100%; margin: 10px auto; border-spacing: 0px;">
			   <tr height="40">
			      <td align="left" width="100">
			          <button type="button" class="btn" onclick="javascript:location.href='<%=cp%>/qAnda/list.do';">새로고침</button>
			      </td>
			      <td align="center">
			          <form name="searchForm" action="<%=cp%>/qAnda/list.do" method="post">
			      ...
			      <td align="right" width="100">
			          <button type="button" class="btn" onclick="javascript:location.href='<%=cp%>/qAnda/created.do';">글올리기</button>
			      </td>
			   </tr>
			</table>
        </div>
